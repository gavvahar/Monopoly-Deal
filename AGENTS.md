...
1. Game Rules Engine (Importance: 90)
...
Core Game System (Importance: 85/100)
An automotive-themed Monopoly Deal variant implementing specialized car property trading mechanics and custom rent calculations.

Card System (/cards.py)
- Car property sets organized by manufacturer
- Wild card system supporting multi-manufacturer compatibility
- Specialized action cards ("Garage Takeover", "Track Day Fees")
- Property values reflecting real car market dynamics

Game Rules (/rules.py)
- Rent calculation based on car collection completion
- Modified property set requirements for automotive theme
- Building mechanics adapted for garage/dealership concepts
- "Cut the Engine" action resolution (Just Say No variant)
- Car property trade payment processing

State Management (/game.py)
- Automotive deck composition and management
- Car collection progress tracking
- Win conditions tied to manufacturer set completion
- Turn sequencing with car-specific actions

Domain Model Highlights
1. Manufacturer-based property categorization (Tesla, Lexus, etc.)
2. Market value-driven property system
3. Car collection multipliers for rent calculations
4. Automotive-themed action system
5. Custom win conditions based on car set completion
